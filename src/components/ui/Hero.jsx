...
const Hero = () => {
  return (
    <section className="relative w-full min-h-dvh overflow-hidden">
      ...
      {/* Content Container */}
      <div className="xl:container mx-auto relative z-10 px-4 sm:px-6 lg:px-8 flex items-center min-h-dvh py-20 sm:py-24 lg:py-28">
        <div className="w-full max-w-4xl mx-auto lg:mx-0 text-center md:text-left">
          {/* Top Badge */}
          ...
          <h1 className="mb-4 sm:mb-5 lg:mb-6 font-heading capitalize">
            ...
            <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[64px] font-bold leading-[1.1] sm:leading-[1.15] tracking-tight bg-gradient-accent bg-clip-text text-transparent">
              sacrificial animal
            </span>
          </h1>

          {/* Subheadline */}
          <p className="text-sm sm:text-[15px] md:text-base lg:text-[17px] leading-relaxed sm:leading-[1.65] max-w-xl lg:max-w-2xl mx-auto md:mx-0 font-body text-white/75 sm:text-white/78 px-2 sm:px-0">
          ...
          {/* Stats Row */}
          <div className="flex items-center justify-center md:justify-start gap-4 sm:gap-6 lg:gap-8 mt-10 sm:mt-12 lg:mt-14 flex-wrap">
            {[
